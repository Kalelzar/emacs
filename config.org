...
(defun --init-message (str) (message (concat "[config] " str)))

(--init-message "Initializing in config.org")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp :tangle yes
(--init-message "Setting personal information")
...
#+BEGIN_SRC emacs-lisp :tangle yes
(--init-message (concat "Set custom file to " (prin1-to-string (expand-file-name "custom.el" user-emacs-directory))))
(setq custom-file (expand-file-name "custom.el" user-emacs-directory))
(--init-message "Loading custom file...")
(load custom-file)
(--init-message "Loading custom file... Done")
#+END_SRC
...
Allow the registering of local packages

#+begin_src emacs-lisp :tangle yes
      (defun use-local-package (package &rest args)
...
#+BEGIN_SRC emacs-lisp :tangle yes
  ...
  (use-local-package 'org-link-beautify)
#+END_SRC
...
(--init-message (concat "Set default notes file to: " org-default-notes-file))
#+END_SRC
...
(--init-message "Enabled windmove in org-mode.")
#+end_src
...
#+BEGIN_SRC emacs-lisp :tangle yes
(use-package ewal-doom-themes :ensure t)
...
(use-package filenotify :ensure t)
